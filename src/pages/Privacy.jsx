...
const Privacy = () => {
    ...
    return (
    <main className="max-w-3xl p-4 mx-auto privacy-page">
        <h1>Youplex - Privacy Policy</h1>
        ...
        <li>
        <p><strong>Company</strong> (referred to as either &quot;the Company&quot;, &quot;We&quot;, &quot;Us&quot; or &quot;Our&quot; in this Agreement) refers to Youplex.</p>
        </li>
        <li>
        ...
        <li>
        <p><strong>Website</strong> refers to Youplex, accessible from <a href="https://youplex.ml" rel="external nofollow noopener" target="_blank">https://youplex.ml</a></p>
        </li>
        <li>
        ...
        <ul>
        <li>By email: heyitstay011@gmail.com</li>
        </ul>
    </main>
    )
}
